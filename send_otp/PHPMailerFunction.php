    ...
    foreach ($toEmails as $toEmail) {
        ...
        try {
            ...
            $mail->Body    = "
                ...
                <a href='https://musicians-disk-victorian-antenna.trycloudflare.com/alumni-network/authentication/Registration/register.php' style='background-color: #007bff; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;'>Register Now</a>
                <p>Best regards,</p>
            ...
            $mail->AltBody = "
                ...
                https://musicians-disk-victorian-antenna.trycloudflare.com/alumni-network/authentication/Registration/register.php
                Best regards,
